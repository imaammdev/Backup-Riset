...
- (void) updateView:(NSTimer *)timer  {
    ...
    if (indexLoop==4) // 6
    {
        ...
        NSLog(@"rotx = %f   roty = %f   rotz = %f | total = %f",rotX,rotY,rotZ,totXYZ);
    ...
    //gravityLabelZ.text = [NSString stringWithFormat:@"%s",stateIDstr2];
...
- (void)viewDidLoad {
    ...
    accelerometer.updateInterval = 0.27f;
